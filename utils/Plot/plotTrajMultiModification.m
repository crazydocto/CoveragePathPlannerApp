...
%         end
%         [TrajSeq_new,flag]=trajSeqModification...                 % Generate a new path sequence matrix based on increments
...
%             [Traj_x,Traj_y]=trajDiscrete(TrajSeq_new,Property);    % Obtain the discrete waypoints sequence
